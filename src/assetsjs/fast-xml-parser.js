var parser = (function (t) {
    ...
    function (t, e, r) {
        ...
        (e.isExist = function (t) {
            ...
            (e.merge = function (t, e) {
                if (e)
                    for (
                        var r = Object.keys(e), a = r.length, i = 0;
                        i < a;
                        i++
                    )
                        t[r[i]] = e[r[i]];
    ...
    function (t, e, r) {
        ...
        e.getTraversalObj = function (t, e) {
            ...
            for (
                var h = new RegExp(o, "g"), f = h.exec(t), g = h.exec(t);
                f;
                ...
                if (v === s.CLOSING)
                    d.parent &&
                        f[14] &&
                        (d.parent.val =
                            a.getValue(d.parent.val) + "" + c(f[14], e)),
                        e.stopNodes.length &&
                    ...
                    d &&
                        f[14] &&
                        (d.val = a.getValue(d.val) + "" + c(f[14], e));
                    var b = new n(e.ignoreNameSpace ? f[7] : f[5], d, "");
                    f[8] &&
                        f[8].length > 0 &&
                        (f[8] = f[8].substr(0, f[8].length - 1)),
                        (b.attrsMap = p(f[8], e)),
                        d.addChild(b);
                } else {
                    var N = new n(
                        e.ignoreNameSpace ? f[7] : f[5],
                        d,
                        c(f[14], e)
                    );
                    e.stopNodes.length &&
    ...
    function (t, e, r) {
        ...
        var a = function (t) {
                    ...
                    s =
                        void 0 === (n = e)
                            ...
                            : !(
                                  ...
                                  (!n.attrsMap ||
                                      0 === Object.keys(n.attrsMap).length)
                              ) || i.emptyChar;
                if (!0 === s) {
                    var u = "";
                    if (Array.isArray(r)) {
            ...
            l = function (t, e) {
                return (
                    u(e[0]) || u(t[t.length - 1]) || (t += i.boundryChar), t + e
                );
            },
            u = function (t) {
    ...
    function (t, e, r) {
        ...
        e.convertToJsonString = function (t, e) {
            return (
                ((e = i(e, n.defaultOptions, n.props)).indentBy =
                    e.indentBy || ""),
                s(t, e, 0)
            );
        };
    ...
    function (t, e, r) {
        ...
        function h(t, e, r) {
            for (
                var i = a.getAllMatches(t, d), n = {}, s = 0;
                s < i.length;
                s++
            ) {
                if (0 === i[s][1].length)
            ...
            j2x(t, e) {
                for (
                    ...
                    if (void 0 === t[o]);
                        ...
                        a +=
                            this.indentate(e) + "<" + o + "/" + this.tagEndChar;
                        ...
                        for (
                            var f = Object.keys(t[o]), p = f.length, g = 0;
                            g < p;
                            g++
                        )
                            r +=
