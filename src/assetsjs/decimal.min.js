...
!(function (n) {
    ...
    (y.absoluteValue = y.abs = function () {
        ...
        (y.decimalPlaces = y.dp = function () {
            ...
            if (e) {
                if (
                    ((i = ((n = e.length - 1) - L(this.e / U)) * U), (n = e[n]))
                )
                    for (; n % 10 == 0; n /= 10) i--;
                i < 0 && (i = 0);
            }
        ...
        (y.hyperbolicCosine = y.cosh = function () {
            ...
            (i = o.precision),
                ...
                (e =
                    (r = s.d.length) < 32
                        ? (1 / J(4, (n = Math.ceil(r / 3)))).toString()
        ...
        (y.inverseTangent = y.atan = function () {
            ...
            if (f.isFinite()) {
                ...
                if (h + 4 <= x)
                    return ((o = P(a, h + 4, l).times(0.5)).s = f.s), o;
            }
            for (
                a.precision = u = h + 10,
                    a.rounding = 1,
                    ...
                    : ((n = t.precision),
                      ...
                      (i = (function (n, e) {
                          ...
                          (i = 16 < (i = 1.4 * Math.sqrt(t)) ? 16 : 0 | i),
                              ...
                              (e = W(n, 2, e, e));
                          for (
                              var r, s = new n(5), o = new n(16), u = new n(20);
                              i--;
        ...
        (y.toFraction = function (n) {
            ...
            if (
                ((f = i = new g(1)),
                (o =
                    (s = (e = new g((t = c = new g(0)))).e = k(p) - d.e - 1) %
                    U),
        ...
        (y.toPower = y.pow = function (n) {
            ...
            if (
                ...
                return (
                    (r = I(c, u, i, t)), n.s < 0 ? new c(1).div(r) : _(r, t, s)
                );
            if ((o = u.s) < 0) {
    ...
    function B(n, e) {
        ...
        for (
            ...
            if (
                ((s = _(s.times(n), c, 1)),
                (i = i.times(++a)),
                M((u = o.plus(F(s, i, c, 1))).d).slice(0, c) ===
                    M(o.d).slice(0, c))
            ) {
