...
((global )=>{
    ...
    global.GLOBALPACKAGESTORE = global.GLOBALPACKAGESTORE || [];
    ...
    */
            ...
            function require(packagename) {
              return global.GLOBALPACKAGESTORE[packagename];
            }
            ...
            // //   globalDefQueue[2]
            // );
            // console.log(exportmodule[1]);
            if (Object.keys(exportmodule[0]).length) {
              moduleexport.default = exportmodule[0];
            } else if (Object.keys(exportmodule[1]).length) {
              moduleexport.default = exportmodule[1];
            } else if (
              typeof define.exports !== "undefined"
              //    ||
            ...
            if (typeof packagename !== "undefined") {
              global.GLOBALPACKAGESTORE[packagename] = moduleexport.default;
            }
            console.log("GLOBALPACKAGESTORE", global.GLOBALPACKAGESTORE);
