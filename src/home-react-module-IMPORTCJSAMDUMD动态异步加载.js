  ...
  render() {
    return (
      <div style={{ "min-width": " 100%" }}>
        <div>
          <h1>
            <a href="../index.html">masx200.github.io</a>
          </h1>
        </div>
        <div class="container-lg px-3 my-5 markdown-body">
          ...
          <div class="highlight highlight-source-js">
            <pre>
              ...
              <span class="pl-k">=&gt;</span> <span class="pl-en">console</span>
          ...
          <p>
            ...
            package source code, and put the module into the module repository.
          </p>
          <p>
            And solve the dependencies between the packages, if the "require"
            function in the dependent package needs, then introduce the required
            module package in the module repository
          </p>
          <p>
          ...
          <p>
            次函数,IMPORTCJSAMDUMD.REQUIREPACKAGE,返回模块仓库中的模块,参数 name
            是字符串
          </p>
          <div class="highlight highlight-source-js">
            <pre>
