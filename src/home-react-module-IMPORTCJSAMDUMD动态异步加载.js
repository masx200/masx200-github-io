...
export default class IMPORTCJSAMDUMD动态异步加载 extends React.Component {
  componentDidMount() {
    document.title =
      "masx200的github主页-" +
          ...
          <div style={{ "min-width": " 100%" }}>
            ...
            <div class="container-lg px-3 my-5 markdown-body">
              ...
              <p>
                ...
                <a href="https://github.com/requirejs/requirejs">"requirejs"</a>
                的 "define"函数
              </p>
              ...
              <p>
                2.可以尝试乱序加载有依赖关系的模块包了,加载之前,先把模块的 url
                和 name
