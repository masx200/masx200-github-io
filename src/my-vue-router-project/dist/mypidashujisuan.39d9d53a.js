...
function mystart() {
  ...
  if (document.getElementById("thread").value >= 1 && document.getElementById("thread").value <= 12 && document.getElementById("pichangwei").value >= 1 && document.getElementById("pichangwei").value <= 100) {
    ...
    if (typeof worker1 == "undefined") {
      worker1 = new Worker("/mythread1.9b2d1939.js");
    }
    ...
    myworker.forEach(function (currentValue, index, arr) {
      arr[index] = undefined;
      arr[index] = new Worker("/mythread1.9b2d1939.js");
...
},{"./mythread1.js":[["mythread1.9b2d1939.js","../圆周率计算-可设置圆周率位数-可选择线程个数-多线程大数框架webworker输出useragent大数框架/mythread1.js"],"mythread1.9b2d1939.js.map","../圆周率计算-可设置圆周率位数-可选择线程个数-多线程大数框架webworker输出useragent大数框架/mythread1.js"]}],"C:/Users/ma/node_modules/.bin/node_modules/_parcel-bundler@1.12.3@parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/ma/node_modules/.bin/node_modules/_parcel-bundler@1.12.3@parcel-bundler/src/builtins/hmr-runtime.js","../圆周率计算-可设置圆周率位数-可选择线程个数-多线程大数框架webworker输出useragent大数框架/mypidashujisuan.js"], null)
//# sourceMappingURL=/mypidashujisuan.39d9d53a.js.map