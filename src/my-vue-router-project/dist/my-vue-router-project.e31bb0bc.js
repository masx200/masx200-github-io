...
window.mychangemenu = function () {
  ...
  if (window.location.hash == "#/") {
    ...
    window.myvueobj.$children[0].isActive1 = false; // window.myvueobj.isActive2 = 

    window.myvueobj.$children[0].isActive3 = false;
    window.myvueobj.$children[0].isActive2 = true;
  } else if (window.location.hash == "#/about") {
    window.myvueobj.$children[0].isActive1 = false;
    window.myvueobj.$children[0].isActive2 = false; // window.myvueobj.isActive3 = false;

    window.myvueobj.$children[0].isActive3 = true;
  }
};

myonload2 = function myonload2() {
  // jQuery - AJAX load() 方法
  ...
  Router = VueRouter; // Vue.use(Router)

  Vue.use(VueRouter); //    window.myvueapp=
  ...
  App = {
    ...
    data: function data() {
      return {
        ...
        isActive3: window.location.hash == "#/about" ? true : false // myroutename: window.location.hash
  ...
  huami = {
    ...
    mounted: function mounted() {
      // window.handleClick2()
      window.mychangemenu(); // if (!importScripts) {
  ...
  home = {
    ...
    data: function data() {
      return {
        msg: "Welcome to Your Vue.js App" // myroutename: window.location.hash
  ...
  */
  ...
  Vue.component(App.name, App); // export default new Router({
  // Vue.use(VueRouter)
  ...
  router = new Router({
    routes: [{
      path: '/about',
      name: 'about',
      component: about // component:()=>import( '@/components/about')

    }, {
      path: '/',
      name: 'home',
      component: home // component:()=>import( '@/components/home')

    }, {
      path: '/huami',
      name: 'huami',
      component: huami // component:()=>import( '@/components/home')
  ...
  window.myvueobj = new Vue({
    ...
    template: '<App/>',
    data: function data() {
      return {// isActive1:  window.location.hash == "#/"?true:false,
        // isActive2:  window.location.hash == "#/huami"?true:false,
...
},{}]},{},["C:/Users/ma/node_modules/.bin/node_modules/_parcel-bundler@1.12.3@parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
//# sourceMappingURL=/my-vue-router-project.e31bb0bc.js.map