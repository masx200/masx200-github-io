...
import mypidashujisuanbigint from "./圆周率计算-可设置圆周率位数-可选择线程个数-多线程大数框架webworker输出useragent大数框架/mypidashujisuan-bigint.js";
import mypidashujisuandecimal from "./圆周率计算-可设置圆周率位数-可选择线程个数-多线程大数框架webworker输出useragent大数框架/mypidashujisuan-decimal.js";
var React = window.IMPORTCJSAMDUMD.REQUIREPACKAGE("react");
export default class picalc extends React.Component {
  componentDidMount() {
    document.title =
      "masx200的github主页-" +
