/* https://cdn.staticfile.org/fast-xml-parser/3.12.16/parser.js
 */
var parser = /******/ (function(modules) {
  // webpackBootstrap
  /******/ // The module cache
  ...
  /******/ /******/ return __webpack_require__(
    (__webpack_require__.s = "./src/parser.js")
  );
  /******/
})(
  /************************************************************************/
  ...
  \*************************/
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var buildOptions = __webpack_require__(/*! ./util */ "./src/util.js")
          .buildOptions;
        var defaultOptions = {
              ...
              if (
                ...
                for (var _j = 0; _j < L; _j++) {
                  attrStr +=
                    ...
                    Ks[_j] +
                    '="' +
                    this.options.attrValueProcessor("" + jObj[key][Ks[_j]]) +
                    '"';
                }
              } else {
  ...
  \*************************/
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var x2j = __webpack_require__(
          /*! ./xmlstr2xmlnode */ "./src/xmlstr2xmlnode.js"
        );
        var buildOptions = __webpack_require__(/*! ./util */ "./src/util.js")
          .buildOptions;
          ...
          for (var index = 0; index < keys.length; index++) {
            ...
            if (node.child[tagname] && node.child[tagname].length > 1) {
              ...
              for (var tag in node.child[tagname]) {
                jObj[tagname].push(
                  convertToJson(node.child[tagname][tag], options)
                );
              }
            } else {
          ...
          if (util.isEmptyObject(jObj)) {
            ...
            if (util.isExist(node.val)) {
              if (
                ...
                jObj +=
                  '"' + options.textNodeName + '" : ' + stringval(node.val);
              }
            }
          } //add value
  ...
  \***********************/
      ...
      /***/ function(module, exports, __webpack_require__) {
        "use strict";
        var nodeToJson = __webpack_require__(
          /*! ./node2json */ "./src/node2json.js"
        );
        var xmlToNodeobj = __webpack_require__(
          /*! ./xmlstr2xmlnode */ "./src/xmlstr2xmlnode.js"
        );
        var x2xmlnode = __webpack_require__(
          /*! ./xmlstr2xmlnode */ "./src/xmlstr2xmlnode.js"
        );
        var buildOptions = __webpack_require__(/*! ./util */ "./src/util.js")
          .buildOptions;
        ...
        exports.convertTonimn = __webpack_require__(
          /*! ../src/nimndata */ "./src/nimndata.js"
        ).convert2nimn;
        exports.getTraversalObj = xmlToNodeobj.getTraversalObj;
        exports.convertToJson = nodeToJson.convertToJson;
        exports.convertToJsonString = __webpack_require__(
          /*! ./node2json_str */ "./src/node2json_str.js"
        ).convertToJsonString;
        exports.validate = __webpack_require__(
          /*! ./validator */ "./src/validator.js"
        ).validate;
        exports.j2xParser = __webpack_require__(
          /*! ./json2xml */ "./src/json2xml.js"
        );
  ...
  \*******************************/
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var regx =
          "<((!\\[CDATA\\[([\\s\\S]*?)(]]>))|(([\\w:\\-._]*:)?([\\w:\\-._]+))([^>]*)>|((\\/)(([\\w:\\-._]*:)?([\\w:\\-._]+))\\s*>))([^<]*)"; //const tagsRegx = new RegExp("<(\\/?[\\w:\\-\._]+)([^>]*)>(\\s*"+cdataRegx+")*([^<]+)?","g");
            ...
            if (tagType === TagType.CLOSING) {
              ...
              if (
                ...
                currentNode.val = xmlData.substr(
                  ...
                  tag.index - currentNode.startIndex - 1
                );
              }
              ...
              if (options.cdataTagName) {
                ...
                currentNode.val =
                  util.getValue(currentNode.val) + options.cdataPositionChar; //add rest value to parent node
                if (tag[14]) {
              ...
              if (
                options.stopNodes.length &&
                options.stopNodes.includes(_childNode2.tagname)
              ) {
