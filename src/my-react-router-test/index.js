	...
	class App extends React.Component {
		...
		render() {
			return ( <
				...
				<
				h1 > 欢迎登陆页面！ < /h1> <
				p > < a href = "https://weibo.com/2174458781?/profile?rightmod=1&wvr=6&mod=personinfo&is_all=1" >
				一生忽而得一夏当司掌好年华的微博_微博 <
				/a></p >
				<
	...
	class Apphome extends React.Component {
		...
		render() {
			return ( <
				...
				{
					/*                                         
					                                       //</ul> {window.myisactive1 ? "active" : ""} onClick={refreshall1}> */
				}
				...
				{
					/*                                         
					                                        {window.myisactive2 ? "active" : ""} onClick={refreshall2}> */
				}
