  ...
  function (_React$Component3) {
    ...
    _createClass(rssreader, [{
      ...
      value: function componentDidMount() {
        ...
        jiazaiload = function jiazaiload(myid) {
          ...
          if (typeof $(myselectorid).attr("src") == "undefined") {
            ...
            $.get($(myselectorid).attr("src"), function (data, status) {
              console.log(status, _typeof(data), data); // if (status != "success") {
              //     console.log("加载失败")
              //     return
              // }

              xmlDoc = data; // console.log(status, typeof data, data)

              x = xmlDoc.getElementsByTagName("item");

              for (i = 0; i < x.length; i++) {
                onetitle = x[i].getElementsByTagName("title")[0].childNodes[0].nodeValue; // onedescription=x[i].getElementsByTagName("description")[0].childNodes[0].nodeValue;
      ...
      value: function render() {
        ...
        }, window.myrsscontent.map(function (e) {
    ...
    _createClass(Apphome, [{
      ...
      value: function render() {
        return React.createElement(BrowserRouter, {
          ...
          to: "/rssreader"
        }, "rssreader")), React.createElement("li", {
          id: "mynav2",
...
},{}]},{},["C:/Users/ma/node_modules/.bin/node_modules/_parcel-bundler@1.12.3@parcel-bundler/src/builtins/hmr-runtime.js","index.jsx"], null)
//# sourceMappingURL=/my-react-router-test.78399e21.js.map