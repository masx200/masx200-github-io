...
},{}],"JSfuck-and-hieroglyphy-Decoder-and-ENCODER/jsfuck-encode-html.js":[function(require,module,exports) {
"use strict";
  ...
  $(window).one("load", function () {
    ...
    function encode() {
      ...
      */
      ...
      if (!myservice) {
        myservice = new Worker("/service-worker-jsfuck.948e99dd.js");
        console.log("创建新线程", "service-worker-jsfuck.js");
      }

      myservice.postMessage([$2("input").value, $2("eval").checked, $("#jsfuckscript").attr("src")]);
      ...
      myservice.onmessage = function (e) {
        ...
        $2("stats").innerHTML = output.length + " chars";
        mui(document.getElementById("encode")).button("reset"); //   myservice.terminate();
    ...
    $("#encode").click(encode); // $2("encode").onclick = encode;
    // $2("eval").onchange = encode;

    $("#eval").change(encode); // window.onload = () => { encode() };
    // $2("run").onclick =
...
},{"../拉伸导航栏与主体部分的顶部距离.js":"拉伸导航栏与主体部分的顶部距离.js","./service-worker-jsfuck.js":[["service-worker-jsfuck.948e99dd.js","JSfuck-and-hieroglyphy-Decoder-and-ENCODER/service-worker-jsfuck.js"],"service-worker-jsfuck.948e99dd.js.map","JSfuck-and-hieroglyphy-Decoder-and-ENCODER/service-worker-jsfuck.js"]}],"node_modules/_parcel-bundler@1.12.3@parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/_parcel-bundler@1.12.3@parcel-bundler/src/builtins/hmr-runtime.js",0,"JSfuck-and-hieroglyphy-Decoder-and-ENCODER/jsfuck-encode-html.js"], null)
//# sourceMappingURL=/jsfuck-encode-html.c638d49b.js.map