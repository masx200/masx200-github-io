...
(function () {
  ...
  var myptext, myshurukuangneirong, p, threadgeshu, x, piwei, myworker, eventdata, strt, finishflag, durt, endt, testname;
  ...
  function lashentextarea() {
    ...
    setTimeout(function () {
      for (var _i = 0, _ids = ids; _i < _ids.length; _i++) {
        value = _ids[_i];
        var myptext = document.getElementById(value); // textarea.scrollHeight = 60
  ...
  function threadfinish() {
    if (threadgeshu == finishflag.filter(function (currentValue) {
      ...
      myptext = document.getElementById("tp");
      myshurukuangneirong += String(eventdata);
      myptext.value = myshurukuangneirong; // jisuanfinishflag = 1;
