...
},{}],"JSfuck-and-hieroglyphy-Decoder-and-ENCODER/service-worker-jsfuck.js":[function(require,module,exports) {
"use strict";

var _jsfuck = _interopRequireDefault(require("./jsfuck.js"));
...
// (() => {
var mymessagehandler = function mymessagehandler(e) {
  var _console;
  ...
  (_console = console).log.apply(_console, _toConsumableArray(d)); // globalimport(d[2]);
  // mui(document.getElementById("encode")).button("loading");


  var output = _jsfuck.default.encode(d[0], d[1]); // $2("output").value = output;
...
},{"./jsfuck.js":"JSfuck-and-hieroglyphy-Decoder-and-ENCODER/jsfuck.js"}],"node_modules/_parcel-bundler@1.12.3@parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/_parcel-bundler@1.12.3@parcel-bundler/src/builtins/hmr-runtime.js","JSfuck-and-hieroglyphy-Decoder-and-ENCODER/service-worker-jsfuck.js"], null)
//# sourceMappingURL=/service-worker-jsfuck.948e99dd.js.map